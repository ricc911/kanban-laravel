        ...
        <section data-auth class="grid gap-6 md:grid-cols-2">
            <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                ...
                <form data-login-form class="mt-6 space-y-4">
                    ...
                    <button
                        class="w-full rounded-lg bg-indigo-600 px-4 py-2.5 font-semibold text-white hover:bg-indigo-700">Login</button>
                </form>
            </div>
            ...
            <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                ...
                <form data-register-form class="mt-6 space-y-4">
                    ...
                    <button
                        class="w-full rounded-lg bg-slate-900 px-4 py-2.5 font-semibold text-white hover:bg-slate-700">Registrati</button>
                </form>
            </div>
        ...
        <section data-dashboard class="hidden">
            <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                <div class="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <button data-logout
                        class="rounded-lg border border-slate-300 px-4 py-2 text-sm font-semibold hover:bg-slate-50">Logout</button>
                </div>
            </div>
            <div class="mt-8">
